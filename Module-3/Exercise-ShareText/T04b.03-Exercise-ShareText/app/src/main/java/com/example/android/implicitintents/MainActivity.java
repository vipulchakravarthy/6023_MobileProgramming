...
public class MainActivity extends AppCompatActivity {
    ...
    void shareText(String str) {
        ...
        String textToShare = "hello all";

        ShareCompat.IntentBuilder.from(this).setChooserTitle(title).setType(mineType).setText(textToShare).startChooser();
    }
